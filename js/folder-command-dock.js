(function () {
  ...
  style.textContent = [
    ...
    'body.ps-olx-mode .topbar nav a,body.ps-olx-mode .topbar .main-nav a,body.ps-olx-mode .main-nav a{color:#1f4560 !important;font-weight:800;}',
    ...
    'body.ps-olx-mode .section > .container,body.ps-olx-mode main > .container,body.ps-olx-mode main .shell .container{color:#2f4f69 !important;}',
    'body.ps-olx-mode .section-header p,body.ps-olx-mode .section-note,body.ps-olx-mode .section-intro,body.ps-olx-mode .tiny-note,body.ps-olx-mode .results-meta,body.ps-olx-mode .dash-meta,body.ps-olx-mode .board-status,body.ps-olx-mode .feature-status,body.ps-olx-mode .feature-finder-meta,body.ps-olx-mode .home-shortcut-note,body.ps-olx-mode .home-folder-status{color:#476880 !important;}',
